...
const en: Translations = {
  ...
  'hero.subheadline': 'Upload your official Instagram Data ZIP to check follower changes. No login, password, OAuth, API, or account connection.',
  ...
  'features.title': 'Choose a Safer Way to Check Unfollowers',
  ...
  'faq.a3': 'No. SafeUnfollow has zero ban risk because it never accesses or acts on your Instagram account. There are no automated follows, unfollows, messages, or other account activity.',
...
const ko: Translations = {
  ...
  'hero.subheadline': '공식 Instagram 데이터 ZIP을 업로드해 팔로워 변화를 확인하세요. 로그인, 비밀번호, OAuth, API, 계정 연결이 필요 없습니다.',
  ...
  'features.title': '더 안전한 언팔 확인 방법을 선택하세요',
