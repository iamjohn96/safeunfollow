...
const en: Translations = {
  ...
  'hero.subheadline': 'See mutuals, one-way follows, and follower changes from one official export. No login, password, OAuth, API, or account connection.',
...
const es: Translations = {
  ...
  'hero.subheadline': 'Consulta seguimientos mutuos, relaciones unidireccionales y cambios de seguidores desde una exportación oficial. Sin login, OAuth, API ni conexión de cuenta.',
...
const pt: Translations = {
  ...
  'hero.subheadline': 'Veja conexões mútuas, relações unilaterais e mudanças de seguidores em uma exportação oficial. Sem login, OAuth, API ou conexão de conta.',
  ...
  'trust.no_ban_risk': 'Sem risco para a conta',
...
const ru: Translations = {
  ...
  'hero.subheadline': 'Просматривайте взаимные и односторонние подписки, а также изменения подписчиков из официального экспорта. Без входа, OAuth, API и подключения аккаунта.',
  ...
  'trust.no_ban_risk': 'Без риска для аккаунта',
