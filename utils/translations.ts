...
const en: Translations = {
  ...
  'hero.cta': 'Request Instagram Data',
  'hero.cta_secondary': 'Already have the ZIP? Upload now',
  ...
  'features.title': 'SafeUnfollow vs. Login-Based Unfollow Apps',
  ...
  'faq.q2': 'Is my Instagram account connected?',
...
const ko: Translations = {
  ...
  'hero.cta': 'Instagram 데이터 요청하기',
  'hero.cta_secondary': 'ZIP이 있나요? 지금 업로드',
  'how.title': '사용 방법',
  ...
  'features.title': 'SafeUnfollow와 로그인 기반 언팔 앱 비교',
