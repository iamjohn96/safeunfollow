...
const pt: Translations = {
  ...
  'upload.formats': 'Aceita arquivos .zip ou .json da exportação de dados do Instagram',
  'upload.processing': 'Processando seu arquivo…',
  'upload.error.invalid': 'Formato inválido. Envie um arquivo .zip ou .json do Instagram.',
  'upload.error.missing': 'Não foi possível encontrar dados de seguidores/seguidos. Confira se você baixou a exportação correta.',
...
const ru: Translations = {
  ...
  'upload.formats': 'Поддерживаются .zip и .json из экспорта данных Instagram',
  'upload.processing': 'Обработка файла…',
  'upload.error.invalid': 'Неверный формат. Загрузите файл Instagram .zip или .json.',
  'upload.error.missing': 'Данные подписчиков/подписок не найдены. Проверьте экспорт Instagram.',
