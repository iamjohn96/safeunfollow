...
const en: Translations = {
  ...
  'nav.premium': 'Premium',
  'hero.badge': '365+ users • 10+ countries',
  'hero.headline': 'See Who Isn\'t Following You Back on Instagram',
  'hero.subheadline': 'No login required. No ban risk. 100% private — processed entirely on your device.',
  'hero.cta': 'Check Now — It\'s Free',
  'hero.cta_secondary': 'I already have my file →',
  'how.title': 'How It Works',
  'how.step1.title': 'Download Your Data',
  'how.step1.desc': 'Request your Instagram data export from the app. It takes a few minutes.',
  'how.step2.title': 'Upload Your File',
  'how.step2.desc': 'Drag and drop the ZIP or JSON file — everything stays on your device.',
  'how.step3.title': 'See Results Instantly',
  'how.step3.desc': 'View who doesn\'t follow you back and track changes over time.',
  'features.title': 'Why SafeUnfollow?',
  'features.safe.title': 'Zero Ban Risk',
  'features.safe.desc': 'We never access your Instagram account. No credentials, no API calls, no bot activity.',
  ...
  'features.instant.desc': 'Upload your file and see who doesn\'t follow you back in seconds.',
  'faq.title': 'Frequently Asked Questions',
  'faq.q1': 'Is my account safe?',
  'faq.a1': 'Completely safe. SafeUnfollow never connects to Instagram. You upload your own data export file, and everything is processed locally on your device. No credentials are ever entered or stored.',
  'faq.q2': 'What file do I need to upload?',
  'faq.a2': 'You need the data export from Instagram. Go to Settings → Your activity → Download your information. Select followers and following data in JSON format. We accept the full ZIP archive or individual JSON files.',
  ...
  'premium.title': 'Track Changes Over Time',
  'premium.subtitle': 'Upgrade to see who unfollowed you since last time and export your data.',
...
const ko: Translations = {
  ...
  'nav.snapshots': '스냅샷',
  'nav.premium': '프리미엄',
  'hero.badge': '365+ 사용자 • 10+ 국가',
  'hero.headline': '인스타그램에서 맞팔 안 한 계정을 확인하세요',
  'hero.subheadline': '로그인 불필요. 차단 위험 없음. 100% 비공개 — 기기에서 완전히 처리됩니다.',
  'hero.cta': '지금 확인하기 — 무료',
  'hero.cta_secondary': '파일이 이미 있어요 →',
  'how.title': '사용 방법',
  'how.step1.title': '데이터 다운로드',
  'how.step1.desc': '인스타그램 앱에서 데이터 내보내기를 요청하세요. 몇 분이면 됩니다.',
  'how.step2.title': '파일 업로드',
  'how.step2.desc': 'ZIP 또는 JSON 파일을 드래그 앤 드롭하세요 — 모든 것이 기기에 남습니다.',
  'how.step3.title': '즉시 결과 확인',
  'how.step3.desc': '맞팔 안 한 계정을 확인하고 시간이 지남에 따른 변화를 추적하세요.',
  'features.title': 'SafeUnfollow를 선택하는 이유',
  'features.safe.title': '차단 위험 제로',
  'features.safe.desc': '인스타그램 계정에 절대 접근하지 않습니다. 자격 증명, API 호출, 봇 활동 없음.',
  'features.private.title': '100% 비공개',
  'features.private.desc': '데이터가 브라우저를 벗어나지 않습니다. 모든 처리가 기기에서 로컬로 이루어집니다.',
  'features.instant.title': '즉각적인 결과',
  'features.instant.desc': '파일을 업로드하면 몇 초 안에 맞팔 안 한 계정을 확인할 수 있습니다.',
  'faq.title': '자주 묻는 질문',
  'faq.q1': '계정이 안전한가요?',
  'faq.a1': '완전히 안전합니다. SafeUnfollow는 인스타그램에 연결하지 않습니다. 본인의 데이터 내보내기 파일을 업로드하고, 모든 것이 기기에서 로컬로 처리됩니다. 자격 증명은 입력하거나 저장되지 않습니다.',
  'faq.q2': '어떤 파일을 업로드해야 하나요?',
  'faq.a2': '인스타그램의 데이터 내보내기 파일이 필요합니다. 설정 → 내 활동 → 정보 다운로드로 이동하세요. JSON 형식으로 팔로워 및 팔로잉 데이터를 선택하세요. 전체 ZIP 아카이브 또는 개별 JSON 파일을 허용합니다.',
  ...
  'faq.a4': '프리미엄은 시간이 지남에 따른 변화를 추적하기 위한 무제한 스냅샷, 데이터 CSV 내보내기, 스냅샷 간 새로운 언팔로워와 새로운 팔로워를 보여주는 전체 변경 이력 타임라인을 잠금 해제합니다.',
  'premium.title': '시간 경과에 따른 변화 추적',
  'premium.subtitle': '지난번 이후 누가 언팔로우했는지 확인하고 데이터를 내보내세요.',
